...
def menu_utilizadores():
    while True:
        ...
        if opcao == "1":
            ...
            if code == 201:
                print("Utilizador criado com sucesso! ID: " + obj["id_utilizador"])
            else:
                print(obj)
            ...
            if code == 200:
                print("Deixou de seguir o artista!")
            else:
                print(obj)
...
def menu_artistas():
    while True:
        ...
        if opcao == "1":
            ...
            if code == 201:
                print("Artista criado com sucesso! ID: " + obj["id_artista"])
            else:
                print(obj)
            ...
            if code == 200:
                print("Utilizador passou a seguir o artista!")
            else:
                print(obj)
